% etalon-250613(SECTION) | User Commands
%
% "June 25 2025"
...
etalon-250613 - program to do something

# SYNOPSIS

**etalon-250613** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**etalon-250613** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **etalon-250613** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**etalon-250613** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    etalon-250613. See **foo.conf**(5) for further details.
...
**etalon-250613** provides some return codes, that can be used in scripts:
...
vlinnik <vlinnik@mail.ru>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 vlinnik
